...
const BLOG = {
  ...
  AUTHOR: NEXT_PUBLIC_AUTHOR || 'tangly1024', // 作者
  BIO: NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: NEXT_PUBLIC_KEYWORDS || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱
  CONTACT_WEIBO: NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页
  CONTACT_TELEGRAM: NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
